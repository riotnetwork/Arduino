...
void MoodLight::setHSB(uint16_t hue, uint8_t sat, uint8_t val) { 
...
uint8_t MoodLight::getRed(){

  return _red;

}

uint8_t MoodLight::getGreen(){

  return _green; 

}

uint8_t MoodLight::getBlue(){

  return _blue;

}

uint8_t MoodLight::getDc(uint8_t val){
  return dc[val];
}
